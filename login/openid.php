...
class LightOpenID
{
    ...
    function authUrl($immediate = false)
    {
        ...
        if (!$this->server) {
			echo "openid.php 即將執行discover identity"."<br>";
    ...
    function validate()
    {
		...
		echo "openid.php 即將執行discover claimed_id"."<br>";
