<?php
	...
	if($_POST['stuID'] != NULL || $_POST['name'] != NULL || $_POST['dep'] != NULL)
	{
		...
		if($ret_search)
		{
			...
			{
// send_pass_hour_admit_student.php
				$message = "<h3>搜尋結果</h3>
							<form id=\"form2\" name=\"form2\" action=\"send_pass_hour_admit_student.php?id=".$act_id."\" method=\"post\">
...
<!-- Archives -->
			<div id="main">
				<div id="welcome" class="post">
					<a href="pass_hour_admit.php" style="float: right; color: red">> 返回時數核可</a>
					<h3>時數核可(校內)</h3>
				...
				<?if ($row['act_post'] == 1){?>
					<h3>搜尋名單</h3>
					<form id="form1" name="form1" action="pass_hour_admit_student.php?id=<?=$act_id?>" method="post">
...
<!-- Submit -->					
				...
				<?}
					...
					<a><font color="red">此活動尚未公告</font></a>
				<?}?>
<?php
...
?>
						<tr>							
							<td align="center"><a href="pass_del_student.php?id=<?=$id?>&amp;act=<?=$act_id?>" onClick="return confirm('確定刪除?');"><img src="images/cross.png" style="border: none;" /></a></td>
