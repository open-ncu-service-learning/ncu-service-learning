...
<!-- Sidebar -->
			<div id="sidebar" class="col-lg-offset-1 col-lg-2 col-xs-3">
...
?>
				<ul style="margin-top: 15px;">
					...
					<li><a href="https://docs.google.com/forms/d/e/1FAIpQLScgsTss_qiCtV4pfKKwdIu983imi7zc-yxk12iSRtBv564qhQ/viewform?c=0&w=1" title="網系統bug回報">系統bug回報</a></li>
				</ul>
<?php
	}
	// 活動單位
